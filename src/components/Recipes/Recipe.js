        ...
        <div className="recipe">
          ...
          <div className='recipe-image-and-ingredientes'>
            ...
            <div className='recipe-ingredients-container'>
              ...
              <ul className='recipe-ul'>{post.ingredients.map((ingredient => (<li className='recipe-li'>{ingredient}</li>)))}</ul>
            </div>
          </div>
          <div className='recipe-steps-container container'>
            <h3>Начин на приготвяне:</h3>
            <ul className='recipe-ul'>{post.steps.map((step => (<li className='recipe-li'>{step}</li>)))}</ul>
          </div>
